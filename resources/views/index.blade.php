        ...
        <div class="container">
            <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
                ...
                <div class="col-md-8 col-sm-12 text-center ftco-animate">
                    ...
                    <p class="mb-4 mb-md-5">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Rem, deleniti
                        eaque ipsa, nesciunt veritatis sunt labore animi distinctio fuga et.</p>
                    ...
                    <div class="col-md-12 nav-link-wrap mb-5">
                        <div class="nav ftco-animate nav-pills justify-content-center" id="v-pills-tab" role="tablist"
                            ...
                            <a class="nav-link active" id="v-pills-1-tab" data-toggle="pill" href="#v-pills-1"
                                role="tab" aria-controls="v-pills-1" aria-selected="true">Machine à Café</a>

                            <a class="nav-link" id="v-pills-2-tab" data-toggle="pill" href="#v-pills-2" role="tab"
                                aria-controls="v-pills-2" aria-selected="false">Café</a>
                                    ...
                                    <div class="col-md-4 text-center">
                                        <div class="menu-wrap">
                                            ...
                                            <div class="text">
                                                ...
                                                <p><a href="#" class="btn btn-primary btn-outline-primary">Ajouter au
                                                        panier</a></p>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="tab-pane fade" id="v-pills-2" role="tabpanel" aria-labelledby="v-pills-2-tab">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 text-center">
                                        <div class="menu-wrap">
                                            <a href="#" class="menu-img img mb-4"
                                                style="background-image: url(images/coffee-1291656_640.jpg);"></a>
                                            <div class="text">
                                    ...
                                    <div class="col-md-4 text-center">
                                        <div class="menu-wrap">
                                            <a href="#" class="menu-img img mb-4"
                                                style="background-image: url(images/coffee-beans-2258839_640.jpg);"></a>
                                            <div class="text">
                            ...
                            <div class="tab-pane fade" id="v-pills-3" role="tabpanel" aria-labelledby="v-pills-3-tab">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 text-center">
                                        <div class="menu-wrap">
                                            <a href="#" class="menu-img img mb-4"
                                                style="background-image: url(images/coffee-1209090_640.jpg);"></a>
                                            <div class="text">
                                                <h3><a href="#">Hot Cake Honey</a></h3>
                                                <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia.</p>
                                                <p class="price"><span>2 000F CFA</span></p>
